      ...
      <main>
        ...
        <section className="bg-slate-50 py-24 lg:py-32 border-b border-[#17306D]/5" data-animate>
          <div className="mx-auto max-w-7xl px-6 lg:px-10 text-center">
            <p className="text-sm font-medium uppercase tracking-widest text-[#F97316] mb-6">
              The Bouza Story
            </p>
            <h1 className="text-4xl lg:text-6xl font-medium tracking-tight text-[#17306D] leading-tight mb-8">
              Connect. Deliver. Excel.
            </h1>
            <p className="text-xl font-medium text-[#0640CE] max-w-2xl mx-auto mb-6">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
              ...
              <div className="w-full lg:w-1/2">
                <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden bg-slate-100 border border-[#17306D]/5 shadow-xl">
              ...
              <div className="w-full lg:w-1/2 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-sm font-medium uppercase tracking-widest text-[#17306D]/50">Founded 2023 • Nairobi, Kenya</span>
                </div>
                
                <h2 className="text-3xl lg:text-4xl font-medium tracking-tight text-[#17306D] mb-6">
                  Bridging the gap in global freight.
                </h2>
                
                <div className="space-y-6 text-base font-normal text-[#17306D]/75 leading-relaxed">
                  <p>
        ...
        <section className="bg-[#17306D] py-24 lg:py-32 text-white" data-animate>
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div className="text-center mb-16 lg:mb-24">
              ...
              <p className="text-lg font-normal text-white/70 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#263D86]/40 border border-white/10 p-8 rounded-3xl">
                <Cpu size={32} className="text-[#F97316] mb-6" />
                <h3 className="text-xl font-medium mb-4">Technological Innovation</h3>
              ...
              <div className="bg-[#263D86]/40 border border-white/10 p-8 rounded-3xl">
                <TrendingUp size={32} className="text-[#F97316] mb-6" />
                <h3 className="text-xl font-medium mb-4">Trans-border Scalability</h3>
                <p className="text-sm font-normal text-white/70 leading-relaxed">
              ...
              <div className="bg-[#263D86]/40 border border-white/10 p-8 rounded-3xl">
                <ShieldCheck size={32} className="text-[#F97316] mb-6" />
                <h3 className="text-xl font-medium mb-4">Unwavering Reliability</h3>
                <p className="text-sm font-normal text-white/70 leading-relaxed">
        ...
        <section className="py-24 lg:py-32 bg-slate-50 border-t border-[#17306D]/5" data-animate>
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div className="text-center mb-16">
              <p className="text-sm font-medium uppercase tracking-widest text-[#F97316] mb-4">Identity & Meaning</p>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-8">
                ...
                {/* The Blue Card */}
                <div className="bg-white p-8 rounded-3xl border border-[#17306D]/5 shadow-sm flex items-start gap-6">
                  <div className="w-16 h-16 rounded-full bg-[#0640CE] flex-shrink-0 shadow-[0_0_20px_rgba(6,64,206,0.3)]"></div>
                  <div>
                    <h3 className="text-xl font-medium text-[#17306D] mb-3">Corporate Blue</h3>
                ...
                {/* The Orange Card */}
                <div className="bg-white p-8 rounded-3xl border border-[#17306D]/5 shadow-sm flex items-start gap-6">
                  <div className="w-16 h-16 rounded-full bg-[#F97316] flex-shrink-0 shadow-[0_0_20px_rgba(249,115,22,0.3)]"></div>
                  <div>
                    <h3 className="text-xl font-medium text-[#17306D] mb-3">Velocity Orange</h3>
                    <p className="text-sm font-normal text-[#17306D]/75 leading-relaxed">
              ...
              {/* The "Z" Logo Display */}
              <div className="w-full lg:w-1/2">
                <div className="h-full bg-[#17306D] rounded-3xl p-10 flex flex-col items-center justify-center text-center border border-[#17306D]/10 relative overflow-hidden">
                  
                  {/* Subtle background graphics */}
                  <div className="absolute top-0 right-0 w-64 h-64 bg-[#0640CE]/20 blur-3xl rounded-full"></div>
                  <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#F97316]/10 blur-3xl rounded-full"></div>
                  ...
                  <h3 className="text-2xl font-medium text-white mb-4 z-10">The Forward Z</h3>
                  <p className="text-base font-normal text-white/70 max-w-sm z-10 leading-relaxed">
